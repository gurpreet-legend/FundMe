...
contract FundMe {
    ...
    event Funded(address _from, uint256 _ethValue);
    ...
    function fund() public payable  {
        uint256 fundedAmount = msg.value.convertToUsd();
        require(fundedAmount >= MINIMUM_USD, "You need to spend more ETH!");
        addressToAmount[msg.sender] += fundedAmount;
